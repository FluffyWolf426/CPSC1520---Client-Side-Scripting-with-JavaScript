...
let toLearnList = document.querySelector(".to-learn-stickies");
let understoodList = document.querySelector(".understood-stickies");
...
stickies.forEach((stickyDetail)=>{
    // create new cards
    let card = new (0, _card.Card)({
        title: stickyDetail.title,
        description: stickyDetail.description,
        learnListElement: toLearnList,
        understoodListElement: understoodList
    });
});
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","./utils/card":"k3bE5"}],"i5LP7":[function() {},{}],"k3bE5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Card", ()=>Card);
var _card = require("../dom/card");
class Card {
    constructor({ title, description, learnListElement, understoodListElement }){
        // let's just add the title and description to the 
        // object that will be created.
        this.title = title;
        this.description = description;
        this.element = (0, _card.createCardElement)({
            title: title,
    ...
    moveToTop() {
        this.learnListElement.insertBefore(this.element, this.learnListElement.firstElementChild);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../dom/card":"9N6C8"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9OWDf","bDbGG"], "bDbGG", "parcelRequire0fc1")
