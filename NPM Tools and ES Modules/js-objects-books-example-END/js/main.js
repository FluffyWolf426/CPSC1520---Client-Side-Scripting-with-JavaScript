...
/*
    ...
    Sample HTML for render books - this function should receive the list of 
    books to render.
    <tr>
...
(function () {
  ...
  filterForm.addEventListener('submit', (evt) => {
    ...
    if (title !== '') {
      theBooks = getBooksFilter(title, 'title', theBooks);
    }
    if (author !== '') {
      theBooks = getBooksFilter(author, 'author', theBooks);
    }
  ...
  function renderAuthorOptions(books) {
    ...
    // TODO: render a select option for each author
  ...
  function getAuthors(books) {
    ...
    let distinctAuthors = authors.filter((author, idx) => {
