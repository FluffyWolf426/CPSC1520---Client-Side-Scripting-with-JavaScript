...
var _foodThoughtsChart = require("./food-thoughts-chart");
...
(0, _foodTimesChart.renderFoodTimesChart)(foodTimesChartElement);
(0, _foodThoughtsChart.renderFoodThoughtsChart)(foodThoughtsChartElement);

},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","./food-times-chart":"extoe","./food-thoughts-chart":"6UHMt"}],"i5LP7":[function() {},{}],"extoe":[function(require,module,exports) {
...
const renderFoodTimesChart = (element)=>{
    ...
    console.log(config);
    // display my chart
    new (0, _autoDefault.default)(element, config);
};

},{"chart.js/auto":"d8NN9","./food.js":"6SwWI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const renderFoodThoughtsChart = (element)=>{
    // set up the data
    const data = {
        labels: (0, _food.getFoodThoughtKeys)(),
        datasets: [
            {
                label: "Dans Thoughts about food.",
                data: (0, _food.getFoodThoughtsValues)(),
                backgroundColor: [
                    "red",
                    "green",
                    "blue",
...
},{"chart.js/auto":"d8NN9","./food":"6SwWI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iSP81","1Z4Rq"], "1Z4Rq", "parcelRequire0fc1")
