...
const addNewLap = () => {
    ...
    // document create element method.
    let listItem = document.createElement("li")
    // add the class
    listItem.classList.add("list-group-item")

    // create the text node
    let textNode = document.createTextNode(`Lap ${currentLap}: ${getReadableTime(lapTime)}`)
    
    // append the text node to list item
    listItem.append(textNode)

    // append it to the page
    allLaps.append(listItem)
